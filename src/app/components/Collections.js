            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                <div className="transform group-hover:-translate-y-2 transition-transform duration-300">
                  ...
                  <p className="text-gray-200 mb-3">{cat.description}</p>
                  <div className="flex items-center justify-between opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <span className="text-sm font-medium">{cat.items}</span>
                    <button className="bg-yellow-600 hover:bg-yellow-700 px-6 py-2 rounded-full text-sm font-medium transition-colors duration-200">
                      Explore
                    </button>
                  </div>
                </div>
